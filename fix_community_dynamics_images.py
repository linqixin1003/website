...
def fix_community_dynamics_images():
    """修复所有语言版本的群落动态文章头图"""
    ...
    # 目标图片URL
    target_image = "url('../../images/head_community_dynamics.webp') center/cover;"
    
    fixed_count = 0
    
    for lang in languages:
        file_path = f"{lang}/ecology/10-community-dynamics.html"
    ...
    print("✅ 所有群落动态文章的头图已更新为 head_community_dynamics.webp")

if __name__ == "__main__":
    fix_community_dynamics_images()