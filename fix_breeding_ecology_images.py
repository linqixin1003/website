...
def fix_breeding_ecology_images():
    """修复所有语言版本的繁殖生态学文章头图"""
    ...
    # 目标图片URL
    target_image = "url('../../images/head_breeding_ecology.webp') center/cover;"
    
    fixed_count = 0
    
    for lang in languages:
        file_path = f"{lang}/ecology/04-breeding-ecology.html"
    ...
    print("✅ 所有繁殖生态学文章的头图已更新为 head_breeding_ecology.webp")

if __name__ == "__main__":
    fix_breeding_ecology_images()