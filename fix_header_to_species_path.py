...
def fix_header_to_species_path():
    """修正6个头图的URL路径 - 从 images/birds/ 改为 images/birds/species/"""
        ...
        try:
            ...
            for category_key, category_data in data.get("articleCategories", {}).items():
                ...
                for article in articles:
                    ...
                    # 检查是否包含需要修正的头图路径
                    if "/images/birds/" in image_url and not "/images/birds/species/" in image_url:
                        for header_image in header_image_fixes.keys():
                            if header_image in image_url:
                                # 修正路径：从 images/birds/ 改为 images/birds/species/
                                new_image_url = image_url.replace("/images/birds/", "/images/birds/species/")
    ...
    print("\n修正的路径:")
    print("从: https://linqixin1003.github.io/website/images/birds/")
    print("到: https://linqixin1003.github.io/website/images/birds/species/")

if __name__ == "__main__":
    print("🚀 开始修正头图URL路径到species目录")
    print("="*60)
    fix_header_to_species_path()